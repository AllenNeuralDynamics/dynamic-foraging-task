...
3. For the first session of a new mouse:
...
4. For a mouse that already started training
...
5. Apply and lock training parameters
...
7. Override stage (not recommended)
...
8. Override curriculum (not recommended)
