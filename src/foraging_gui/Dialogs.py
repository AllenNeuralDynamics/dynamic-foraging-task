...
class RandomRewardDialog(QDialog):
    ...
    def _give_reward(self,volume:float,side:int):
        ...
        if side==0:
            ...
            self.random_reward_par['RandomWaterVolume'][0]=self.ManualWaterVolume[0]+float(volume)/1000
        elif side==1:
            ...
            self.random_reward_par['RandomWaterVolume'][1]=self.ManualWaterVolume[1]+float(volume)/1000
