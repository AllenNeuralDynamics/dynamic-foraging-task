    ...
    lick_spouts = [
        d.RewardSpout(
            ...
            lick_sensor=d.Device(
                device_type="Lick Sensor", name="Lick Sensor Left", manufacturer=lick_spout_manufacturer
            ),
        ),
        d.RewardSpout(
            ...
            lick_sensor_type=d.LickSensorType("Capacitive"),
            lick_sensor=d.Device(
                device_type="Lick Sensor", name="Lick Sensor Right", manufacturer=lick_spout_manufacturer
            ),
        ),
    ]
