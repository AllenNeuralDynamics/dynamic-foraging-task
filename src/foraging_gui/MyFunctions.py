    ...
    def _GetLaserWaveForm(self):
        ...
        if (
            ...
            if self.CLP_OffsetStart < 0:
                logging.warning(
                    "Please set offset start to be positive!",
                    extra={"tags": [self.win.warning_log_tag]},
                )
    ...
    def _GetLaserAmplitude(self):
        ...
        if self.CLP_Location == "Laser_1":
            if self.CLP_Laser1Power == "":
                logging.warning(
                    "No amplitude for Laser_1 defined!",
                    extra={"tags": [self.win.warning_log_tag]},
                )
            else:
            ...
            if self.CLP_Laser2Power == "":
                logging.warning(
                    "No amplitude for Laser_2 defined!",
                    extra={"tags": [self.win.warning_log_tag]},
                )
            else:
            ...
            if self.CLP_Laser1Power == "" or self.CLP_Location == "":
                logging.warning(
                    "No amplitude for Laser_1 or Laser_2 laser defined!",
                    extra={"tags": [self.win.warning_log_tag]},
                )
            else:
                Laser1PowerAmp = eval(self.CLP_Laser1Power)
