...
class Ui_Camera(object):
    def setupUi(self, Camera):
        ...
        Camera.resize(275, 284)
        self.FrameRate = QtWidgets.QLineEdit(Camera)
        self.FrameRate.setGeometry(QtCore.QRect(120, 154, 80, 20))
    ...
    def retranslateUi(self, Camera):
        ...
        self.FrameRate.setText(_translate("Camera", "500"))
