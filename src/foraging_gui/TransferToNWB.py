...
def bonsai_to_nwb(fname, save_folder=save_folder):
    ...
    nwbfile.add_trial_column(
        name="rewarded_historyL", description="The reward history of left lick port"
    )
    nwbfile.add_trial_column(
        name="rewarded_historyR", description="The reward history of right lick port"
    )
    nwbfile.add_trial_column(
    ...
    nwbfile.add_trial_column(
        name="block_min", description="The minimum length allowed for each block"
    )
    nwbfile.add_trial_column(
        name="block_max", description="The maxmum length allowed for each block"
    )
    nwbfile.add_trial_column(
    ...
    nwbfile.add_trial_column(
        name="delay_min", description="The minimum duration(s) allowed for each delay"
    )
    nwbfile.add_trial_column(
        name="delay_max", description="The maxmum duration(s) allowed for each delay"
    )
    nwbfile.add_trial_column(
        name="delay_duration",
    ...
    nwbfile.add_trial_column(
        name="ITI_min", description="The minimum duration(s) allowed for each ITI"
    )
    nwbfile.add_trial_column(
        name="ITI_max", description="The maxmum duration(s) allowed for each ITI"
    )
    nwbfile.add_trial_column(
        name="ITI_duration",
    ...
    # reward delay
    nwbfile.add_trial_column(
        name="reward_delay", description="The delay between choice and reward delivery"
    )
    # auto water
    ...
    nwbfile.add_trial_column(
        name="laser_rampingdown", description="The ramping down time of the laser"
    )
    nwbfile.add_trial_column(
    ...
    nwbfile.add_trial_column(
        name="auto_train_engaged", description="Whether the auto training is engaged"
    )
    nwbfile.add_trial_column(
    ...
    nwbfile.add_trial_column(
        name="auto_train_stage", description="The current stage of auto training"
    )
    nwbfile.add_trial_column(
